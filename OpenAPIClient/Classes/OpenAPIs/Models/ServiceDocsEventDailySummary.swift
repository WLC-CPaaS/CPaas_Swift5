//
// ServiceDocsEventDailySummary.swift
//
...
public struct ServiceDocsEventDailySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelEventDailySummary]?
    ...
    public init(data: [ModelEventDailySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
