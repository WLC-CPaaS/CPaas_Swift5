//
// ProvisioningDocsDocsConfigFileOutput.swift
//
...
public struct ProvisioningDocsDocsConfigFileOutput: Codable, JSONEncodable, Hashable {
    ...
    public init(data: String? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
