...
public struct ServiceDocsCallDetail: Codable, JSONEncodable, Hashable {

    public var data: [ModelCallDetail]?
    ...
    public init(data: [ModelCallDetail]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
