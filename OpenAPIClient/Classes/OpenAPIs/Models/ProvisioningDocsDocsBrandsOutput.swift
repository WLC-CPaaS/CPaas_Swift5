//
// ProvisioningDocsDocsBrandsOutput.swift
//
...
public struct ProvisioningDocsDocsBrandsOutput: Codable, JSONEncodable, Hashable {

    public var data: [ModelsBrand]?
    ...
    public init(data: [ModelsBrand]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
