//
// ServiceDocsAccountPhonenumberGetAll.swift
//
...
public struct ServiceDocsAccountPhonenumberGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServicePhonenumberOutput]?
    ...
    public init(data: [ServicePhonenumberOutput]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
