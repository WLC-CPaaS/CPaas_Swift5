//
// ServiceDocsEventMonthlySummary.swift
//
...
public struct ServiceDocsEventMonthlySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelEventMonthlySummary]?
    ...
    public init(data: [ModelEventMonthlySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
