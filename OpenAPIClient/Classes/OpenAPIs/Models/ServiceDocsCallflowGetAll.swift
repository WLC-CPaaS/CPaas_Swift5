//
// ServiceDocsCallflowGetAll.swift
//
...
public struct ServiceDocsCallflowGetAll: Codable, JSONEncodable, Hashable {

    public var data: ServiceCallflowOutputShort?
    ...
    public init(data: ServiceCallflowOutputShort? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
