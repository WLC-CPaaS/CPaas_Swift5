//
// ProvisioningDocsDocsModelOutput.swift
//
...
public struct ProvisioningDocsDocsModelOutput: Codable, JSONEncodable, Hashable {

    public var data: [ModelsModel]?
    ...
    public init(data: [ModelsModel]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
