//
// ServiceDocsTemporalRuleGetAll.swift
//
...
public struct ServiceDocsTemporalRuleGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceTemporalRuleOutputShort]?
    ...
    public init(data: [ServiceTemporalRuleOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
