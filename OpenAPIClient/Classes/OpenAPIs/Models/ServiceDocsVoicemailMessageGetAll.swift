//
// ServiceDocsVoicemailMessageGetAll.swift
//
...
public struct ServiceDocsVoicemailMessageGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceVoicemailMessageOutput]?
    ...
    public init(data: [ServiceVoicemailMessageOutput]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
