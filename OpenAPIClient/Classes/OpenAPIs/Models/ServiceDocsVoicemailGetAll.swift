//
// ServiceDocsVoicemailGetAll.swift
//
...
public struct ServiceDocsVoicemailGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceVoicemailOutputShort]?
    ...
    public init(data: [ServiceVoicemailOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
