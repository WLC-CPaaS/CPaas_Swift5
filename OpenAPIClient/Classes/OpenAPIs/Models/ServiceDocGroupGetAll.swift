...
public struct ServiceDocGroupGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceGroupOutputShort]?
    ...
    public init(data: [ServiceGroupOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
