...
public struct ServiceDocsEventDetail: Codable, JSONEncodable, Hashable {

    public var data: [ModelEventDetail]?
    ...
    public init(data: [ModelEventDetail]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
