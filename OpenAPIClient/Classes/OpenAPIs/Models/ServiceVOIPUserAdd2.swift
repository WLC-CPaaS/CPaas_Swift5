...
public struct ServiceVOIPUserAdd2: Codable, JSONEncodable, Hashable {
    ...
    public init(callForward: ModelsCallForward? = nil, callRecording: ModelsCallRecordingSettings? = nil, callerId: ModelsUserOutputFullCallerid? = nil, doNotDisturb: ModelsVOIPSharedDoNotDisturb? = nil, email: String, enabled: Bool? = nil, firstName: String, lastName: String, musicOnHold: ModelsMusicOnHold? = nil, presenceId: String? = nil, timezone: String? = nil, verified: Bool? = nil) {
