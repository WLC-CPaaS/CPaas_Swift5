...
public struct ServiceDocsDeviceStatus: Codable, JSONEncodable, Hashable {

    public var data: [ServiceDeviceStatusOutput]?
    ...
    public init(data: [ServiceDeviceStatusOutput]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
