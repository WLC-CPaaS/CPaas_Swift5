...
public struct MenuOutputList: Codable, JSONEncodable, Hashable {

    /** Data Payload */
    public var data: [MenuOutputListData]?
    ...
    public init(data: [MenuOutputListData]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
