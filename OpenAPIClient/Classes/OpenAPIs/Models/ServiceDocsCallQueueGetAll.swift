//
// ServiceDocsCallQueueGetAll.swift
//
...
public struct ServiceDocsCallQueueGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceCallQueueOutputShort]?
    ...
    public init(data: [ServiceCallQueueOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
