//
// ServiceDocsFeatureDailySummary.swift
//
...
public struct ServiceDocsFeatureDailySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelFeatureDailySummary]?
    ...
    public init(data: [ModelFeatureDailySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
