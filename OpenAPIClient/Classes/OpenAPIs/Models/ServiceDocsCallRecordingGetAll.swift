//
// ServiceDocsCallRecordingGetAll.swift
//
...
public struct ServiceDocsCallRecordingGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceCallRecordingOutput]?
    ...
    public init(data: [ServiceCallRecordingOutput]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
