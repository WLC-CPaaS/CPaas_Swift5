//
// ServiceDocsCallDailySummary.swift
//
...
public struct ServiceDocsCallDailySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelCallDailySummary]?
    ...
    public init(data: [ModelCallDailySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
