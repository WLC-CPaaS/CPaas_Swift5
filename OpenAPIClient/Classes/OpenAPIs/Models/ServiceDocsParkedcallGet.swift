//
// ServiceDocsParkedcallGet.swift
//
...
public struct ServiceDocsParkedcallGet: Codable, JSONEncodable, Hashable {
    ...
    public init(data: [Dictionary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
