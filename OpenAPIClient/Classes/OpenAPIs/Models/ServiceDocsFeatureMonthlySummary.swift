//
// ServiceDocsFeatureMonthlySummary.swift
//
...
public struct ServiceDocsFeatureMonthlySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelFeatureMonthlySummary]?
    ...
    public init(data: [ModelFeatureMonthlySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
