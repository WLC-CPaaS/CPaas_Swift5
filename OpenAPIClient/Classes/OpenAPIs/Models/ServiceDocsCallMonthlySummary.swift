//
// ServiceDocsCallMonthlySummary.swift
//
...
public struct ServiceDocsCallMonthlySummary: Codable, JSONEncodable, Hashable {

    public var data: [ModelCallMonthlySummary]?
    ...
    public init(data: [ModelCallMonthlySummary]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
