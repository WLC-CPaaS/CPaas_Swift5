...
public struct ServiceDocsUserGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceUserOutputShort]?
    ...
    public init(data: [ServiceUserOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
