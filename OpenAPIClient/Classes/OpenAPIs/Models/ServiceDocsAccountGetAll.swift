//
// ServiceDocsAccountGetAll.swift
//
...
public struct ServiceDocsAccountGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceAccountOutputShort]?
    ...
    public init(data: [ServiceAccountOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
