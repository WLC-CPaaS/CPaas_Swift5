//
// ServiceDocsTemporalRuleSetGetAll.swift
//
...
public struct ServiceDocsTemporalRuleSetGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceTemporalRuleSetOutputShort]?
    ...
    public init(data: [ServiceTemporalRuleSetOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
