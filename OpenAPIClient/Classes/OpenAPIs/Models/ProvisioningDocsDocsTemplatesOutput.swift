//
// ProvisioningDocsDocsTemplatesOutput.swift
//
...
public struct ProvisioningDocsDocsTemplatesOutput: Codable, JSONEncodable, Hashable {

    public var data: [ModelsTemplate]?
    ...
    public init(data: [ModelsTemplate]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
