...
public struct ServiceDocsDeviceGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceDeviceOutputShort]?
    ...
    public init(data: [ServiceDeviceOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
