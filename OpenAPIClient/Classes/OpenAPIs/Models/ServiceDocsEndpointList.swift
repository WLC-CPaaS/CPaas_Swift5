...
public struct ServiceDocsEndpointList: Codable, JSONEncodable, Hashable {

    public var data: [ModelEndpointList]?
    ...
    public init(data: [ModelEndpointList]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
