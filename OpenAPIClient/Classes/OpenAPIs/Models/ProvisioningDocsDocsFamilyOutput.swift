//
// ProvisioningDocsDocsFamilyOutput.swift
//
...
public struct ProvisioningDocsDocsFamilyOutput: Codable, JSONEncodable, Hashable {

    public var data: [ModelsFamily]?
    ...
    public init(data: [ModelsFamily]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
