...
public struct ServiceDocsCdrGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceCdrOutputShort]?
    ...
    public init(data: [ServiceCdrOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
