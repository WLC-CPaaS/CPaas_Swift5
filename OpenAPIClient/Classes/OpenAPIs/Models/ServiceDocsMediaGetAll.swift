...
public struct ServiceDocsMediaGetAll: Codable, JSONEncodable, Hashable {

    public var data: [ServiceMediaOutputShort]?
    ...
    public init(data: [ServiceMediaOutputShort]? = nil, nextStartKey: String? = nil, pageSize: Int? = nil, requestId: String? = nil, startKey: String? = nil, statusCode: Int? = nil) {
        self.data = data
